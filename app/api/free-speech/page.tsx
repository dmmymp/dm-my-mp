...
export default function FreeSpeechPage() {
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="text-gray-700 mb-4">
        Don’t let government overreach silence your voice. Use this tool to write to your MP about free speech concerns, join the movement for open expression, and share your letter anonymously on X to inspire others. Visit the <a href="/" className="text-blue-600 hover:underline">homepage</a> to get started.
      </p>
